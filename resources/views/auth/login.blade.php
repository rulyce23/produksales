                ...
                <div class="card-body p-0">
                    <div class="row">
                        <div class="col-lg-6 d-none d-lg-block">
                           <center> <img src ="img/rullz.jpg" width="350" height="300"  style="border-radius: 50%; margin-top:50px;"></center>
                        </div>
                        <div class="col-lg-6">
                            <div class="p-5">
                                ...
                                <form method="POST" action="{{ route('authenticate') }}" class="user">
                                    ...
                                    <div class="text-center">
                                        <a class="small" href="{{ route('forget.password.get') }}">{{ __('Forgot Password') }}</a>
                                    </div>
                                <hr>
